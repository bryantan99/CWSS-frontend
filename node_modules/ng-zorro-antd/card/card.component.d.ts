 ...
 */
import { ChangeDetectorRef, ElementRef, OnDestroy, QueryList, TemplateRef } from '@angular/core';
...
export declare class NzCardComponent implements OnDestroy {
    ...
    private destroy$;
    constructor(nzConfigService: NzConfigService, cdr: ChangeDetectorRef, elementRef: ElementRef);
    ngOnDestroy(): void;
