...
NzLayoutComponent.ɵfac = function NzLayoutComponent_Factory(t) { return new (t || NzLayoutComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
NzLayoutComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzLayoutComponent, selectors: [["nz-layout"]], contentQueries: function NzLayoutComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵclassProp("ant-layout-has-sider", ctx.listOfNzSiderComponent.length > 0);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NzLayoutComponent, [{
  ...
  `,
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { listOfNzSiderComponent: [{
...
NzLayoutModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule, NzIconModule, LayoutModule, PlatformModule]] });
