...
NzListComponent.ɵfac = function NzListComponent_Factory(t) { return new (t || NzListComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
NzListComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzListComponent, selectors: [["nz-list"], ["", "nz-list", ""]], contentQueries: function NzListComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, hostVars: 14, hostBindings: function NzListComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("ant-list-vertical", ctx.nzItemLayout === "vertical")("ant-list-lg", ctx.nzSize === "large")("ant-list-sm", ctx.nzSize === "small")("ant-list-split", ctx.nzSplit)("ant-list-bordered", ctx.nzBordered)("ant-list-loading", ctx.nzLoading)("ant-list-something-after-last-item", ctx.hasSomethingAfterLastItem);
    ...
    } }, directives: [ɵngcc1.NgIf, ɵngcc5.NzSpinComponent, ɵngcc1.NgTemplateOutlet, ɵngcc1.NgForOf, NzListHeaderComponent, ɵngcc3.NzStringTemplateOutletDirective, ɵngcc6.NzRowDirective, ɵngcc6.NzColDirective, NzListEmptyComponent, NzListFooterComponent, NzListPaginationComponent], encapsulation: 2, changeDetection: 0 });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NzListComponent, [{
  ...
  `,
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { nzBordered: [{
            type: Input
        }], nzGrid: [{
            type: Input
        }], nzItemLayout: [{
