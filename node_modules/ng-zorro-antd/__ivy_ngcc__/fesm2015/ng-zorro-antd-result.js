...
import { Directive, Component, ChangeDetectionStrategy, ViewEncapsulation, ElementRef, Input, NgModule } from '@angular/core';
...
NzResultComponent.ɵfac = function NzResultComponent_Factory(t) { return new (t || NzResultComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
NzResultComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzResultComponent, selectors: [["nz-result"]], hostVars: 8, hostBindings: function NzResultComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("ant-result-success", ctx.nzStatus === "success")("ant-result-error", ctx.nzStatus === "error")("ant-result-info", ctx.nzStatus === "info")("ant-result-warning", ctx.nzStatus === "warning");
        ...
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", !ctx.nzExtra);
    } }, directives: function () { return [ɵngcc1.NgIf, ɵngcc2.NzStringTemplateOutletDirective, ɵngcc3.NzIconDirective, ɵngcc1.NgSwitch, ɵngcc1.NgSwitchCase, NzResultNotFoundComponent, NzResultServerErrorComponent, NzResultUnauthorizedComponent]; }, encapsulation: 2, changeDetection: 0 });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzResultComponent, [{
  ...
  `,
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { nzStatus: [{
            type: Input
        }], nzIcon: [{
            type: Input
        }], nzTitle: [{
